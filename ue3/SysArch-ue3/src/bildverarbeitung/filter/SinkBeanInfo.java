...
public class SinkBeanInfo extends SimpleBeanInfo {
    ...
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( bildverarbeitung.filter.Sink.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static final int METHOD_saveData5 = 5;
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_run4] = new MethodDescriptor(framework.endpoint.DataSink.class.getMethod("run", new Class[] {})); // NOI18N
            methods[METHOD_run4].setDisplayName ( "" );
            methods[METHOD_saveData5] = new MethodDescriptor(bildverarbeitung.filter.Sink.class.getMethod("saveData", new Class[] {java.lang.Object.class})); // NOI18N
            methods[METHOD_saveData5].setDisplayName ( "" );
        }
