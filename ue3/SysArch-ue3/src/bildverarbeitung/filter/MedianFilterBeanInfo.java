...
public class MedianFilterBeanInfo extends SimpleBeanInfo {
    ...
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( bildverarbeitung.filter.MedianFilter.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( bildverarbeitung.filter.MedianFilter.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_filter2] = new MethodDescriptor(bildverarbeitung.filter.MedianFilter.class.getMethod("filter", new Class[] {java.lang.Object.class})); // NOI18N
            methods[METHOD_filter2].setDisplayName ( "" );
            methods[METHOD_propertyChange3] = new MethodDescriptor(bildverarbeitung.filter.MedianFilter.class.getMethod("propertyChange", new Class[] {java.beans.PropertyChangeEvent.class})); // NOI18N
