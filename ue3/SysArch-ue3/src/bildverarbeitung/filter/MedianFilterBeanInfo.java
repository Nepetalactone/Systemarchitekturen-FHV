...
public class MedianFilterBeanInfo extends SimpleBeanInfo {
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            methods[METHOD_propertyChange0] = new MethodDescriptor(bildverarbeitung.filter.MedianFilter.class.getMethod("propertyChange", new Class[] {java.beans.PropertyChangeEvent.class})); // NOI18N
