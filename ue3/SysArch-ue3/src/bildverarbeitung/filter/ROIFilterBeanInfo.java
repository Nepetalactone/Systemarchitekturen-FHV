...
public class ROIFilterBeanInfo extends SimpleBeanInfo {
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            methods[METHOD_propertyChange0] = new MethodDescriptor(bildverarbeitung.filter.ROIFilter.class.getMethod("propertyChange", new Class[] {java.beans.PropertyChangeEvent.class})); // NOI18N
