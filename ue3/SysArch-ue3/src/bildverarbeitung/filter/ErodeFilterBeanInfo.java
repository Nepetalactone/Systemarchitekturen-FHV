...
public class ErodeFilterBeanInfo extends SimpleBeanInfo {
    ...
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( bildverarbeitung.filter.ErodeFilter.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            methods[METHOD_propertyChange0] = new MethodDescriptor(bildverarbeitung.filter.ErodeFilter.class.getMethod("propertyChange", new Class[] {java.beans.PropertyChangeEvent.class})); // NOI18N
