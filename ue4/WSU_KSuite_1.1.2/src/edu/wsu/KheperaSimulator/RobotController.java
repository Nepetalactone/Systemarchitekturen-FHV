...
public abstract class RobotController implements Controller {
    ...
    public float[] readLvtImage() {
        return state.lvtArray;
    }
    /*
     * Returns the pixel with maximum intensity
     */

    public float getPixelMaxIntensity() {

        return state.getPixelMaxIntensity();
    }

    /*
     * Returns the pixel with minimum intensity
     */
    public float getPixelMinIntensity() {

        return state.getPixelMinIntensity();
    }
} // RobotController
